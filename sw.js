...
const CACHE = 'jetfor-mnt-v25';
const SHELL = [
  './', './index.html', './app.js', './config.js', './data.js',
  './freq_data.js', './dash_data.js', './da_data.js', './acmaps_data.js', './patch_data.js', './reclass_data.js', './iio_data.js', './forms.js', './docs.js', './auditorias.js',
